...
export default function ContactForm() {
  ...
  return (
    <>
      {subject ? (
        <Text>
          <Link className="float-right px-1 text-lg" onClick={handleReset}>
            <Icon icon={faX} />
          </Link>
          Contacting about <b>{subject}</b>
        </Text>
      ) : (
        <Text variant="muted">Want to learn more about payvault? Have questions?</Text>
      )}
          ...
          <div className="flex justify-between gap-x-1">
            <div className="w-3/4">
              ...
              <select
                ...
                name="subject"
                required
                className="h-full w-full min-w-0 rounded-md border border-transparent bg-white px-1 py-1 font-sans text-base text-gray-800 placeholder-gray-600 outline-none"
          ...
          <div className="flex justify-between gap-x-1">
            <div className="w-3/4">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="h-full w-full min-w-0 appearance-none rounded-md border border-transparent bg-white px-1 py-1 font-sans text-base text-gray-800 placeholder-gray-600 outline-none"
        ...
        {step === 3 && (
          <div>
            <textarea
              ...
              name="message"
              required
              className="w-full min-w-0 appearance-none rounded-md border border-transparent bg-white px-1 py-1 font-sans text-base text-gray-800 placeholder-gray-600 outline-none"
              placeholder="Message..."
