...
export default function HeroTerminal() {
  ...
  return (
    <ul
      className="m-0 flex w-full flex-col overflow-auto rounded-lg border border-solid border-slate-500 bg-slate-900 p-2 font-mono text-sm text-gray-200"
      style={{ height: 230 }}
      ref={terminal}
    >
      <li className="list-none">
